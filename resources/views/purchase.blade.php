...
<form style="margin-left: 500px; margin-bottom:8px;" action="{{url('/save-purchase')}}" role="form" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="number" name="product_quantity" class="form-control" id="" placeholder="Quantity" required="">
    </div>

    <div class="form-group col-md-6">
        <label for="Procut Name">Purchase Price</label>
        <input type="number" name="purchase_price" class="form-control" id="" placeholder="Purchase Price" required="">
    </div>
    <div class="form-group col-md-6">
        <label for="Procut Name">Sale Price</label>
        <input type="number" name="sale_price" class="form-control" id="" placeholder="Sale Price" required="">
    </div>
